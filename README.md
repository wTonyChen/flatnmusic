...
- 可自定义顶栏风格。<sup>仅限 UserCSS 版本</sup><br>
- 支持自定义主题色，动画效果开关、隐藏主页客户端下载选项以及置顶顶栏。<sup>仅限 UserCSS 版本</sup><br>
- 多种字体可供选择。<br>
- 如需实现更多功能，可安装辅助用户脚本提升体验。<sup>[备注3](#%E5%A4%87%E6%B3%A8)</sup>
...
2. 不具备去广告的功能。
3. 搭配辅助用户脚本实现附加功能有：网页高清图片加载、增强版我的音乐页面、增强版用户页面、增强版朋友动态页面和增强版歌手页等。
...
6. Userstyles.org 新版入口：[前往安装](https://userstyles.org/styles/186848)，Userstyles.org 旧版入口（已经停止于版本 0.3.81）：[前往安装](https://userstyles.org/styles/155372)。

<br>

## 帮助

[点此查看帮助](https://github.com/wTonyChen/flatnmusic/wiki)
